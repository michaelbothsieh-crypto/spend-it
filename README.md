...
- **中文標點全形化**,文案遵循 [Humanizer-zh-TW](https://github.com/kevintsai1202/Humanizer-zh-TW) 去 AI 味規則
- `prefers-reduced-motion` 全動畫關閉、鍵盤操作、觸控裝置自動隱藏快捷鍵提示

## 部署

GitHub → Vercel,framework 選 **Other**,root 就是專案目錄,按下去就好。
